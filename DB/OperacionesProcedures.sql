          ...
          ELSE
            ...
            IF estado_cheque = 1 THEN
              ...
              INSERT INTO TRANSACCION(FECHA, TIPO, NATURALEZA, SALDO_INICIAL, SALDO_FINAL, CODIGO_AUTORIZACION, USUARIO_ID_USUARIO, TERMINAL_ID_TERMINAL, CUENTA_NO_CUENTA, ESTADO_TRANSACCION,RECHAZADO,RAZON_RECHAZO)
                ...
                raise_application_error(-20456, 'No se cobró debido a que el cheque fue REPORTADO COMO ROBADO');
            ELSIF estado_cheque = 2 THEN
              ...
              INSERT INTO TRANSACCION(FECHA, TIPO, NATURALEZA, SALDO_INICIAL, SALDO_FINAL, CODIGO_AUTORIZACION, USUARIO_ID_USUARIO, TERMINAL_ID_TERMINAL, CUENTA_NO_CUENTA, ESTADO_TRANSACCION,RECHAZADO,RAZON_RECHAZO)
                ...
                raise_application_error(-20456, 'No se cobró debido a que el cheque fue BLOQUEADO');
            ELSIF estado_cheque = 3 THEN
              ...
              INSERT INTO TRANSACCION(FECHA, TIPO, NATURALEZA, SALDO_INICIAL, SALDO_FINAL, CODIGO_AUTORIZACION, USUARIO_ID_USUARIO, TERMINAL_ID_TERMINAL, CUENTA_NO_CUENTA, ESTADO_TRANSACCION,RECHAZADO,RAZON_RECHAZO)
                ...
                raise_application_error(-20456, 'No se cobró debido a que el cheque fue PERDIDO');
            ELSIF estado_cheque = 4 THEN
              ...
              INSERT INTO TRANSACCION(FECHA, TIPO, NATURALEZA, SALDO_INICIAL, SALDO_FINAL, CODIGO_AUTORIZACION, USUARIO_ID_USUARIO, TERMINAL_ID_TERMINAL, CUENTA_NO_CUENTA, ESTADO_TRANSACCION,RECHAZADO,RAZON_RECHAZO)
                ...
                raise_application_error(-20456, 'No se cobró debido a que el cheque fue PAGADO');
            END IF;
          END IF;
        ELSE
