...
BEGIN
	...
	IF cliente_existe = 1 THEN
		-- CREO SU CUENTA
		INSERT INTO CUENTA(SALDO, SALDO_DISPONIBLE, SALDO_RESERVA, BANCO_ID_BANCO, TIPO_CUENTA_ID_TIPO, ESTADO_CUENTA) VALUES(p_saldo_inicial, 0, 0, p_banco_id_banco, p_tipo_cuenta, p_estado_cuenta)
