...
BEGIN
    ...
    -- REALIZANDO COMPROBACION SI EXISTEN FONDOS
        IF saldo_inicial_origen >= monto THEN
            ...
            INSERT INTO TRANSACCION(ID_TRANSACCION,FECHA, TIPO, NATURALEZA, SALDO_INICIAL, SALDO_FINAL, CODIGO_AUTORIZACION, USUARIO_ID_USUARIO, TERMINAL_ID_TERMINAL, CUENTA_NO_CUENTA, ESTADO_TRANSACCION)
