...
public class Transaccion2 {
    ...
    public Transaccion2(Date fecha, String Tipo, String Naturaleza, double saldo_inicial, double saldo_final, int codigo_autorizacion, int rechazado, String razon_rechazo, int usuario_id_usuario, int terminal_id_terminal, int cuenta_no_cuenta, int estado_transaccion) {
        this.fecha = fecha;
        this.Tipo = Tipo;
